...
func Create(cfg *Config) (*config.Config, error) {
	...
	cfgX.Auth.Provider = "feishu"
	//
	// cfgX.Services.App.Mode = "service"
	// cfgX.Services.App.Service = "https://api.feishu.com/oauth/app"
	// cfgX.Services.User.Mode = "service"
	// cfgX.Services.User.Service = "https://api.feishu.com/user"
	// cfgX.Services.Menus.Mode = "service"
	// cfgX.Services.Menus.Service = "https://api.feishu.com/menus"
	// cfgX.Services.Users.Mode = "service"
	// cfgX.Services.Users.Service = "https://api.feishu.com/users"
	// cfgX.Services.OpenID.Mode = "service"
	// cfgX.Services.OpenID.Service = "https://api.feishu.com/oauth/app/user/open_id"
	//
